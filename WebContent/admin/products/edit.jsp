			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff">
					<select name="category" id="category">
						...
						<option value="shouji">手机</option>
						<option value="shenghuo">生活电器</option>
						<option value="chufang">厨房电器</option>
						<option value="bangong">办公设备</option>
						<option value="yingyin">智能影音</option>
					</select>
				</td>
			</tr>
			<tr>
