...
<div id="divmenu">
		<a href="${pageContext.request.contextPath}/showProductByPage?category=shouji">手机</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=shenghuo">生活电器</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=chufang">厨房电器</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=bangong">办公设备</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=yingyin">智能影音</a>
